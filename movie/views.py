...
def recommend_movie(request):
    ...
    if request.method == "POST":
        ...
        # recorrer películas y buscar la más parecida
        best_movie = None
        max_similarity = -1
        ...
        recommended = (best_movie, round(max_similarity, 4))

    return render(request, "movie/recommend.html", {"recommended": recommended})
